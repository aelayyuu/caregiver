...
class BoomMenu extends StatefulWidget {
  ...
  final List<MenuItemBoom> children;
  ...
  const BoomMenu({
    ...
    this.animatedIcon,
    required this.animatedIconTheme,
    // required this.child,
    this.marginBottom = 0,
    this.marginLeft = 16,
    this.marginRight = 0,
  ...
  @override
  BoomMenuState createState() => BoomMenuState();
}

class BoomMenuState extends State<BoomMenu>
  ...
  void _toggleChildren() {
    ...
    // if (newValue) widget.onOpen();
    _performAnimation();
    // if (!newValue) widget.onClose();
  }
  ...
  Widget _renderButton() {
    ...
    var animatedFloatingButton = AnimatedFloatingButton(
        ...
        onTap: _toggleChildren,
        // callback: (_open) ? _toggleChildren : widget.onPress,
